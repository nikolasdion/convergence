...
// interface SqlEventSlot {
//   event_id: string;
//   slot: string;
// }

// interface SqlAttendee {
//   id: string;
//   name: string;
//   timezone: string;
// }

// interface SqlAttendeeSlot {
//   attendee_id: string;
//   event_id: string;
//   slot: string;
// }
...
//   return await singleQuery<SqlEventSlot>(
//     `SELECT * from event_slot WHERE event_id='${event_id}'`
//   );
// }

// export async function getEvents(): Promise<IEvent[]> {
//   const dbEvents = await singleQuery<SqlEvent>(`SELECT * from event`);
